...
export default function TrailerAndFifthWheelForm() {
  ...
  return (
    <div id="warranty-form" className="max-w-[749px] mx-auto shadow-2xl p-6 sm:p-8 rounded-2xl bg-white mb-20 mt-10 w-[95%] sm:w-[90%] md:w-auto">
